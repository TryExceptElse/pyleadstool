...
"}")
        ...
        self.campaignSelector = QtWidgets.QComboBox(Dialog)
        self.campaignSelector.setObjectName("campaignSelector")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.campaignSelector)
